...
function editRow(button) {
    ...
    row.setAttribute('data-original', JSON.stringify(currentData));
    ...
    row.innerHTML = `
        ...
        <td><input type="text" value="${currentData[13]}"></td>
        <td class="action-buttons">
